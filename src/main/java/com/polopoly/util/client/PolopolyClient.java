...
public class PolopolyClient {
    ...
    public PolopolyContext connect() throws ConnectException {
        ...
        try {
            ...
            cmClient = new CmClientFacade();
            cmClient.setContentRepositoryClient(contentRepositoryClient);
            cmClient.setUserServiceClient(userServiceClient);

            app.addApplicationComponent(contentRepositoryClient);
            app.addApplicationComponent(userServiceClient);
    ...
    private SolrSearchClient createSolrSearchClient(CmClient cmClient,
                                                    final StandardApplication app,
                                                    String indexName)
