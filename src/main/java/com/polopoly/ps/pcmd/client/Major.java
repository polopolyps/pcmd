package com.polopoly.ps.pcmd.client;

public enum Major implements Comparable<Major> {
    UNKNOWN(-1, "unknown"), MAJOR_CONFIG(0, "majorconfig"), ARTICLE(1, "article"), DEPARTMENT(2, "department"),
    CONTENT(3, "content"), LAYOUT_ELEMENT(7, "layoutelement"), WORKFLOW_TYPE(10, "workflowtype"), WORKFLOW(11,
        "workflow"), REFERENCE_METADATA(13, "referencemetadata"), INPUT_TEMPLATE(14, "inputtemplate"), OUTPUT_TEMPLATE(
        15, "outputtemplate"), APP_CONFIG(17, "appconfig"), USER(18, "userdata"), COMMUNITY(19, "community"),
    DISK_FILE_STORAGE(19, "diskfilestorage");

    static {
        ALL_MAJORS =
            new Major[] { MAJOR_CONFIG, ARTICLE, DEPARTMENT, CONTENT, LAYOUT_ELEMENT, WORKFLOW, WORKFLOW_TYPE,
                         REFERENCE_METADATA, INPUT_TEMPLATE, OUTPUT_TEMPLATE, APP_CONFIG, USER, COMMUNITY,
                         DISK_FILE_STORAGE };
    }
