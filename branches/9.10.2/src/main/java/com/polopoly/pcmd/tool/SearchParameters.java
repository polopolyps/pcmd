...
public class SearchParameters implements Parameters {
    ...
    public void getHelp(ParameterHelp help) {
        ...
        help.addOption(SINCE, new IntegerParser(), "Search object whose last committed version is greater than or equal to this version");
        help.addOption(UNTIL, new IntegerParser(), "Search object whose last committed version is less than or equal to this version");
    }
