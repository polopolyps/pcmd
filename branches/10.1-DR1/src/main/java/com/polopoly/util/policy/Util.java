...
public class Util {
	...
	/**
	 * The use of {@link Util#util(ContentListRead, PolopolyContext)} is
	 * preferred.
	 */
	public static ContentListUtil util(ContentListRead contentList,
	...
	public static ContentIdUtil util(ContentId contentId,
			PolopolyContext context) {
		if (contentId == null) {
			return null;
		}
	...
	public static InputTemplateUtil util(InputTemplate inputTemplate,
			PolopolyContext context) {
